...
// Generated Wed Mar 9 18:06:07 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._fullscreen.onclick=function () {
			...
			flag=(me._map_cover.style.visibility=='hidden');
			me._map_cover.style[domTransition]='none';
			me._map_cover.style.visibility=flag?'inherit':'hidden';
			me._map_cover.ggVisible=flag;
		}
		...
		this._toggle_map__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		...
		this._map_display.ggTextDiv.innerHTML="<div id=\"mapdiv\" style=\"width:600px; height:400px\">map goes here!<\/div>";
		this._map_display.appendChild(this._map_display__text);
		this._map.appendChild(this._map_display);
		this._map_title0=document.createElement('div');
		this._map_title0__text=document.createElement('div');
		this._map_title0.className='ggskin ggskin_textdiv';
		this._map_title0.ggTextDiv=this._map_title0__text;
		this._map_title0.ggId="map title";
		this._map_title0.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._map_title0.ggVisible=true;
		this._map_title0.className='ggskin ggskin_text';
		this._map_title0.ggType='text';
		hs ='position:absolute;';
		hs+='left: 139px;';
		hs+='top:  9px;';
		hs+='width: 379px;';
		...
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._map_title0.setAttribute('style',hs);
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 379px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._map_title0__text.setAttribute('style',hs);
		this._map_title0.ggTextDiv.innerHTML="John Dalton - click here for more information";
		this._map_title0.appendChild(this._map_title0__text);
		this._map_title0.onclick=function () {
			me.player.openUrl("http:\/\/www2.mmu.ac.uk\/staff\/buildings\/john-dalton\/","_blank");
		}
		this._map.appendChild(this._map_title0);
		...
		this._map_title.ggTextDiv.innerHTML="John Dalton - click here for more information";
